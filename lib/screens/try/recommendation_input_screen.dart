...
class TryRecommendationInputScreen extends StatelessWidget {
  final PageController pageController;
  TryRecommendationInputScreen({super.key, required this.pageController});
              ...
              visaController.applyRecommendationsOnly().then((value) {
                if (value) {
                  ...
                  Get.snackbar(
                    ...
                    "Success",
                    "You will receive recommendations in an Email",
