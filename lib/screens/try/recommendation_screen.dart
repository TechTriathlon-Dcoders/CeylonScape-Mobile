...
import 'package:CeylonScape/screens/try/recommendation_input_screen.dart';
import 'package:CeylonScape/theme/colors.dart';
import 'package:CeylonScape/theme/fonts.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class TryRecommendationScreen extends StatelessWidget {
  TryRecommendationScreen({super.key});
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: PageView(
          ...
          children: [
            TryRecommendationInputScreen(pageController: _pageController,),
          ],
        ),
      ),
    );
